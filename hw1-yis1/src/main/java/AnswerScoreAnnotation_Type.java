...
/* First created by JCasGen Tue Sep 10 11:14:58 EDT 2013 */
...
/** 
 * Updated by JCasGen Tue Sep 10 11:14:58 EDT 2013
 * @generated */
public class AnswerScoreAnnotation_Type extends TokenAnnotation_Type {
  /** @generated */
  @Override
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("AnswerScoreAnnotation");
  ...
  public double getScore(int addr) {
      ...
      jcas.throwFeatMissing("score", "AnswerScoreAnnotation");
  ...
  public int getAnswer(int addr) {
      ...
      jcas.throwFeatMissing("answer", "AnswerScoreAnnotation");
  ...
  public AnswerScoreAnnotation_Type(JCas jcas, Type casType) {
    ...
    casFeat_answer = jcas.getRequiredFeatureDE(casType, "answer", "AnswerAnnotation", featOkTst);
